...
<?php
    ...
    $sql = "SELECT * FROM `2019-2020` ORDER BY sr_no ASC";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <section>
        <br>
        <br>
        <h1>Placements in 2019-2020</h1>
        <br>
        <br>

        <img src="images/2019-2020.png" alt="Uttar Pradesh National Health Mission" width="70%" class="center">
